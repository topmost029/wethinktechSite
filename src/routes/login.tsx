...
function Login() {
  ...
  return (
    <section className="min-h-screen flex items-center justify-center px-4 py-32 bg-gradient-soft relative overflow-hidden">
      <div className="absolute inset-0 opacity-30" style={{ background: "radial-gradient(circle at 20% 20%, #f5c518 0%, transparent 40%), radial-gradient(circle at 80% 80%, #00C853 0%, transparent 40%)" }} />
      <motion.div
