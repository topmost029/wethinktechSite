  ...
  return (
    <section className="py-24 px-4">
      <div className="container mx-auto">
        ...
        >
          <div className="absolute inset-0 opacity-30" style={{ background: "radial-gradient(circle at 25% 30%, #00C853 0%, transparent 40%), radial-gradient(circle at 80% 70%, #00AEEF 0%, transparent 45%)" }} />
