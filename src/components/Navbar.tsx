      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="flex items-center justify-between h-20">
          <Link to="/" className="flex items-center gap-2">
            <img src={logo.url} alt="WeThinkTech Global Limited" className="h-10 lg:h-12 w-auto" width={200} height={60} />
          </Link>
          ...
          <div className="flex items-center gap-3">
            <Link
              to="/login"
              className="hidden sm:inline-flex items-center justify-center rounded-full px-6 py-2.5 text-sm font-semibold bg-gradient-accent text-accent-foreground shadow-glow hover:scale-105 active:scale-95 transition-transform"
            >
              Login
            </Link>
            <button
